...
// @Summary      下载税金单文件
// @Description  下载指定国家的税金单文件。路径来自 storage.tax-bill-original / tax-bill-backup。含 yyyyMM_ 前缀时优先 backup/yyyy/mm，再在 original 下去前缀查找；无前缀时优先 original，并兼容 backup 树中的 yyyyMM_ 副本。
// @Tags         tax-bill
// @Accept       json
